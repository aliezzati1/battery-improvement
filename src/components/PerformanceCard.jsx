...
function PerformanceCard({ onClick }) {
  ...
  const data = [
    { time: '00', price: 12, battery: 0 },
    { time: '01', price: 8, battery: 0 },
    { time: '02', price: 15, battery: 0 },
    { time: '03', price: 10, battery: 1 },
    { time: '04', price: 18, battery: 1.5 },
    { time: '05', price: 14, battery: 1 },
    { time: '06', price: 25, battery: 0 },
    { time: '07', price: 55, battery: 0 },
    { time: '08', price: 85, battery: 0 },
    { time: '09', price: 110, battery: 0 },
    { time: '10', price: 145, battery: 0 },
    { time: '11', price: 170, battery: 0 },
    { time: '12', price: 190, battery: -1 },
    { time: '13', price: 195, battery: -3.5 },
    { time: '14', price: 185, battery: -2.5 },
    { time: '15', price: 175, battery: -1.5 },
    { time: '16', price: 155, battery: -0.5 },
    { time: '17', price: 125, battery: 0 },
    { time: '18', price: 95, battery: 0 },
    { time: '19', price: 65, battery: 0 },
    { time: '20', price: 45, battery: 0 },
    { time: '21', price: 35, battery: 0 },
    { time: '22', price: 22, battery: 0 },
    { time: '23', price: 15, battery: 0 },
  ]
